        ...
        <div className='h-screen mx-5 sm:mx-auto pt-32'>
            ...
            <div className='max-w-5xl md:px-4 py-8 pb-32 mx-auto space-y-28'>
                ...
                <section className='p-4 md:p-8 bg-gray-100 rounded-lg shadow-2xl'>
                    <h1 className='font-bold text-lg md:text-xl text-blue-500 pb-4'>Warhouse Management </h1>
                    <div className='grid grid-cols-1 gap-0 sm:gap-8 md:grid-cols-3 items-center'>
                        ...
                        <blockquote className='sm:col-span-2'>
                            <p className='text-xs md:text-base'>
                                It is a program to manage one or more stores at the same time and easy to use for a comfortable user experience . 
                                There is adding products, modifying, deleting, knowing the products that have been purchased and sold, retrieving the last invoices that have been sold, exchange and addition permissions
                            </p>
                            <cite className='inline-flex items-center mt-8 not-italic'>
                                <span className='hidden w-6 h-px bg-gray-400 sm:inline-block'></span>
                                <p className='text-xs md:text-base text-gray-500 sm:ml-3'>
                                    React, Tailwind, CSS, Bootstrap, Nodejs, ExpressJs , MongoDB
                                </p>
                            </cite>
